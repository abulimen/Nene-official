...
export function FlexContainer({ node, children, onDragOver, onDragLeave, onDrop, dragOverPosition, className = "", }) {
    ...
    return (<div data-node-id={node.id} data-node-type="container" data-layout-type="flex" className={`
        relative
      ...
      {/* Left edge indicator */}
      {displayPosition === "left" && (<div className="absolute inset-y-0 -left-1 w-1 bg-blue-500/50 rounded-full z-10 pointer-events-none"/>)}

      {/* Right edge indicator */}
      {displayPosition === "right" && (<div className="absolute inset-y-0 -right-1 w-1 bg-blue-500/50 rounded-full z-10 pointer-events-none"/>)}
