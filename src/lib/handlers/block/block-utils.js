 ...
 */
export function getTypeClassName(type) {
    switch (type) {
        case "h1":
 ...
 */
export function buildHTML(textNode, readOnly) {
 ...
 */
export function saveSelection(localRef) {
    if (!localRef.current)
        return null;
    ...
    if (!localRef.current.contains(range.commonAncestorContainer))
        return null;
 ...
 */
export function restoreSelection(localRef, savedSelection) {
