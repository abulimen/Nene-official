 ...
 */
export function createHandleFileChange(params) {
    return async (e) => {
 ...
 */
export function createHandleMultipleFilesChange(params) {
    return async (e) => {
 ...
 */
export function createHandleImageUploadClick(fileInputRef) {
    return () => {
 ...
 */
export function createHandleMultipleImagesUploadClick(multipleFileInputRef) {
    return () => {
 ...
 */
export function createHandleFreeImageFileChange(params) {
    return async (e) => {
 ...
 */
export function createHandleFreeImageUploadClick(freeImageInputRef) {
    return () => {
