 ...
 */
export function getClassesInCategory(category) {
 ...
 */
export function areSameCategory(class1, class2) {
 ...
 */
export function replaceClassInCategory(currentClasses, newClass) {
    if (!currentClasses)
        return newClass;
 ...
 */
export function getReplacementInfo(currentClasses, newClass) {
    const classes = currentClasses.split(' ').filter(Boolean);
    const newCategory = getClassCategory(newClass);
    if (!newCategory) {
        return {
 ...
 */
export function getCurrentClasses(className) {
    if (!className)
        return [];
 ...
 */
export function mergeClasses(existingClassName, newClass) {
