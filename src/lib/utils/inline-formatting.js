 ...
 */
import { hasInlineChildren, getNodeTextContent } from '../types';
/**
 ...
 * ```
 */
export function splitTextAtSelection(content, startOffset, endOffset) {
    return {
 ...
 */
export function convertToInlineFormat(node) {
 ...
 */
export function applyFormatting(node, startOffset, endOffset, className) {
 ...
 */
export function mergeAdjacentTextNodes(children) {
 ...
 */
export function removeFormatting(node, startOffset, endOffset, className) {
    if (!hasInlineChildren(node)) {
 ...
 */
export function getFormattingAtPosition(node, offset) {
    if (!hasInlineChildren(node)) {
